...
- `packages/features/membership/repositories/MembershipRepository.ts` exposes accepted membership checks and admin/owner membership helpers. Current accepted membership is the durable boundary for team access.
